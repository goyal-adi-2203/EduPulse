...
function TeacherAnns() {
    ...
    const handleSearch = () => {
        ...
        var updatedAnnouncements = announcements.filter((obj) => {
            ...
            return (
                ...
                (filters.class_teacher_flag ? parseInt(obj.class_id) === classTeacher[0].class_teacher_flag: true) &&
                (filters.class_id ? obj.class_id === filters.class_id: true) &&
                (filters.subject_name ? obj.subject_name === filters.subject_name: true) &&
                (Object.values(obj).some((val) => {
                    return (keyword ? val.toString().toLowerCase().includes(keyword.toLowerCase()) : true);
                })) 
            );
        });
    ...
    const handleWordSearch = (e) => {
        ...
        if (filters.sortTitle || filters.userCategory || filters.class_id || filters.class_teacher_flag || filters.subject_name) {
        ...
        <div>
            ...
            <div id="filter-menu-admin" className="filter-menu-admin">
                ...
                <select
                    ...
                    onChange={(e) => { setFilters({ ...filters, userCategory: e.target.value }) }}
                ...
                <input
                    ...
                    onChange={(e) => { setFilters({ ...filters, sortTitle: !filters.sortTitle }); }}
                /> Sort by title
                ...
                {classTeacher[0] && Object.values(classTeacher[0])[1] !== "No" &&
                    ...
                    <input
                        ...
                        onChange={(e) => { setFilters({ ...filters, class_teacher_flag: !filters.class_teacher_flag }); }}
                ...
                >
                    ...
                    {classes.map((val, key) => {
                        return (
                        <option value={classes[key].class_id + '-' + classes[key].subject_name}> 
            ...
            <div className="ann-container">
                {(tempAnnouncement.length > 0) ? tempAnnouncement.map((val, key) => {
                    ...
                    (announcements.length > 0) ? announcements.map((val, key) => {
                        const popupId = `ann-pop-up-id-${key}`;
                        const cardId = `ann-card-id-${key}`;
                        // console.log(popupId);
                        return (
