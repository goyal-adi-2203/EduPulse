                ...
                <MDBRow style={{ width: "100%" }}>
                    ...
                    <MDBCol sm='6'>
                        ...
                        <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4' style={{ height: "600px" }}>
                            ...
                            <MDBInput wrapperClass='mb-4 mx-5 w-100' label='User ID' id='formControlLgUsername' type='text' size="lg" value={username} onChange={(e) => setUsername(e.target.value)} />
                            <MDBInput wrapperClass='mb-4 mx-5 w-100' label='Password' id='formControlLgPassword' type='password' size="lg" value={password} onChange={(e) => setPassword(e.target.value)} />
