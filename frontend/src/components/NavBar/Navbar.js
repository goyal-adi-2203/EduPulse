                    ...
                    >
                        ...
                        <Offcanvas.Body>
                            <Nav className="justify-content-end flex-grow-1 pe-3">
                                <Nav.Link style={{ color: "#E5D2CB" }} to="/home" className="offcavas-panel">Home</Nav.Link>
                                <Nav.Link
                                    style={style}
                                    onClick={() => {
                                ...
                                <NavDropdown title="More" id="collpasible-nav-dropdown" className="navbar-dropdown navbar-more offcanvas-panel" style={
                                    { color: "#E5D2CB" }
                                }>
