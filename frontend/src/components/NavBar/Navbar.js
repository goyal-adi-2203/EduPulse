        ...
        <>
            <Navbar fixed="top" key='md' expand='md' className="bg-body-tertiary mb-5 navbar Navbar-main">
                <Container fluid>
                    ...
                    <Navbar.Toggle aria-controls={`offcanvasNavbar-expand-$md`} className="navbar-toggle" />
                    <Navbar.Offcanvas
                    ...
                    >
                        ...
                        <Offcanvas.Body>
                            <Nav className="justify-content-end flex-grow-1 pe-3">
                                <Nav.Link style={{ color: "#E5D2CB" }} href="/home" className="offcavas-panel">Home</Nav.Link>
                                <Nav.Link 
                                    style={style}
                                    onClick={() => {
                                ...
                                <NavDropdown title="More" id="collasible-nav-dropdown" className="navbar-dropdown navbar-more offcanvas-panel" style={
                                    { color: "white" }
                                }>
                                    ...
                                    <NavDropdown.Item href=""
                                        onClick={() => {
                                            const anchor = document.querySelector('#FAQs');
                                            anchor.scrollIntoView({ behavior: 'smooth', block: 'center' });
                                        }}
                                    >
                                        FAQs
                                ...
                                <Nav.Link href="#Login">
                                    ...
                                    >
                                        {isLoading ? 'Loading..' : props.Logintext}
                                    </Button>
                                </Nav.Link>
                            </Nav>
                        </Offcanvas.Body>
