                    ...
                    <div class="row d-flex justify-content-center align-items-center h-100 ">
                        <div class="col col-lg-6 mb-4 mb-lg-0 w-100 admin h-100">
                            <div
                                ...
                                style={{ "border-radius": ".5rem", height: "100vh" }}
                            >
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-6 mb-3">
                                                    <h6>Name</h6>
                                                    <p class="text-muted">{userInfo[0].first_name} {userInfo[0].last_name}</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6>Role</h6>
                                            ...
                                            <div class="row pt-1">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <h6>Phone</h6>
                                                    <p class="text-muted">{userInfo[0].phone_no}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-6 mb-3">
                                                    <h6>Flat No.</h6>
                                                    <p class="text-muted">{userInfo[0].flat_no}</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6>Colony</h6>
                                                    <p class="text-muted">{userInfo[0].colony}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-6 mb-3">
                                                    <h6>District</h6>
                                                    <p class="text-muted">{userInfo[0].district}</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6>Pincode</h6>
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-6 mb-3">
                                                    <h6>Student Id</h6>
                                                    <p class="text-muted">{userInfo[0].student_id}</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6>Name</h6>
                                                    <p class="text-muted">{userInfo[0].first_name} {userInfo[0].last_name}</p>
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-6 mb-3">
                                                    <h6>Gender</h6>
                                                    <p class="text-muted">{userInfo[0].gender}</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6>Role</h6>
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-6 mb-3">
                                                    <h6>Father's Name</h6>
                                                    <p class="text-muted">{userInfo[0].Father_name}</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6>Mother's Name</h6>
                                                    <p class="text-muted">{userInfo[0].Mother_name}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row pt-1">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <h6>Email</h6>
                                                    <p class="text-muted">{userInfo[0].email_id}</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="row pt-1">
                                                ...
                                                <div class="col-6 mb-3">
                                                    ...
                                                    <p class="text-muted">{userInfo[0].class_teacher_flag}</p>
                                                </div>
                                            </div>
