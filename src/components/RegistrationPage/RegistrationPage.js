          ...
          <MDBCard className="my-5 rounded-3 registration-container-inner">
            ...
            <MDBCardBody className="px-5">
                ...
                <div>
                  ...
                  <MDBRow>
                    ...
                    <MDBCol md="6" className="mb-4">
                      ...
                      >
                        <option selected>
                          If class teacher, Select Class else 0
                        </option>
                  ...
                  <MDBRow>
                    <MDBCol md="6" className="mb-4">
                      <select
                        ...
                        aria-label="Default select example"
                        onChange={(e) => {
                          setValues({ ...values, class1: e.target.value });
                        }}
                      >
                        <option selected>Select Class</option>
                        <option value="1">1</option>
                    ...
                    <MDBCol md="6" className="mb-4">
                      <select
                        ...
                        value={null}
                        onChange={(e) => {
                          setValues({ ...values, subject1: e.target.value });
                        }}
                      >
                  ...
                  <MDBRow>
                    <MDBCol md="6" className="mb-4">
                      <select
                        ...
                        aria-label="Default select example"
                        onChange={(e) => {
                          setValues({ ...values, class2: e.target.value });
                        }}
                      >
                        <option selected>Select Class</option>
                        <option value="1">1</option>
                    ...
                    <MDBCol md="6" className="mb-4">
                      <select
                        ...
                        value={null}
                        onChange={(e) => {
                          setValues({ ...values, subject2: e.target.value });
                        }}
                      >
                        <option selected>Select Subject</option>
                        <option value="English">English</option>
                  ...
                  <MDBRow>
                    <MDBCol md="6" className="mb-4">
                      <select
                        ...
                        aria-label="Default select example"
                        onChange={(e) => {
                          setValues({ ...values, class3: e.target.value });
                        }}
                      >
                        <option selected>Select Class</option>
                        <option value="1">1</option>
                    ...
                    <MDBCol md="6" className="mb-4">
                      <select
                        ...
                        value={null}
                        onChange={(e) => {
                          setValues({ ...values, subject3: e.target.value });
                        }}
                      >
                        <option selected>Select Subject</option>
                        <option value="English">English</option>
                  ...
                  <MDBRow>
                    <MDBCol md="6">
                      <MDBInput
                        ...
                        value={values.flatno}
                        onChange={(e) => {
                          setValues({ ...values, flatno: e.target.value });
                        }}
                      />
                    </MDBCol>
                    <MDBCol md="6">
                      <MDBInput
                        ...
                        value={values.colony}
                        onChange={(e) => {
                          setValues({ ...values, colony: e.target.value });
                        }}
                      />
                    </MDBCol>
                  </MDBRow>
              ...
              <div className="registration-buttons">
                ...
                <MDBBtn color="info" className="mb-4" size="lg">
