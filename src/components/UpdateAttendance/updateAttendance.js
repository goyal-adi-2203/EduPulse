        ...
        <div className="attendanceList">
          <MDBTable className="table-attendance-update">
            <MDBTableHead className="student-list-update-heading" dark={true}>
              <tr>
                <td colSpan={13}>Student's Attendance List</td>
              </tr>
            </MDBTableHead>
            <MDBTableHead>
              <tr>
                ...
                {dateArray.map((val, key) => {
                  ...
                  return (
                    <th className=" updateAttendance-th">
                      {date[8] + date[9] + " " + mon}
                    </th>
                  );
                })}
            ...
            <MDBTableBody>
              ...
              <tr id="totPresent">
                <td className="updateAttendance-td"></td>
                <td className="updateAttendance-td">Total</td>
                <td className="updateAttendance-td">Present :</td>
                {dateArray.map((val, key) => {
                  return (
                    <td className="updateAttendance-td">{val.totPresent}</td>
                  );
                })}
              </tr>
            </MDBTableBody>
